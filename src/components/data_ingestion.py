...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            #df=pd.read_csv(os.path.join("D:\Python Machine Learning Pipeline Project\ML_Pipeline_Projects_Completed_by_DJ\Zomato\Zomato_Delivery_Time_Prediction\Data"))
